      ...
      <div class="container">
        <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
          ...
          <div class="col-md-12 ftco-animate text-center">
            <h1 class="mb-2">Selamat Datang Di Website Kami</h1>
           
            <p><a href="#products" class="btn btn-primary btn-md">Silahkan Pesan Sekarang Juga</a></p>
          </div>
      ...
      <div class="container">
        <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
          ...
          <div class="col-sm-12 ftco-animate text-center">
            <h1 class="mb-2">Kami Menyedikan Jasa Desain Grafis</h1>
            
            <p><a href="#products" class="btn btn-primary">Silahkan Pesan Sekarang Juga</a></p>
          </div>
  ...
  <div class="container">
    <div class="row justify-content-center mb-3 pb-3">
      <div class="col-md-12 heading-section text-center ftco-animate">
        <span class="subheading">Desain Terbaru</span>
