...
<div class="hero-wrap hero-bread" style="background-image: url('<?php echo get_theme_uri('images/bg_1.jpg'); ?>');">
    <div class="container">
      <div class="row no-gutters slider-text align-items-center justify-content-center">
        <div class="col-md-9 ftco-animate text-center">
            <p class="breadcrumbs"><span class="mr-2"><?php echo anchor(base_url(), 'Home'); ?></span> <span>Pesanan</span></p>
  ...
  <section class="ftco-section ftco-Pesanan">
          <div class="container">
          ...
          <?php else : ?>
            <div class="row">
              <div class="col-md-12 ftco-animate">
                <div class="alert alert-info">Tidak ada desain dalam Pesanan.<br><?php echo anchor('home', 'Jelajahi desain kami'); ?> Mulailah Proses Pemesanan</div>
              </div>
            </div>
          <?php endif; ?>
          </div>
