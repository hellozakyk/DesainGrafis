    ...
    <form action="<?php echo site_url('shop/checkout/order'); ?>" method="POST">
      ...
      <div class="row justify-content-center">
        <div class="col-xl-7 ftco-animate">
                <h3 class="mb-4 billing-heading">Proses Desain</h3>

                <div class="form-group">
                    <label for="name" class="form-control-label">Proses untuk (nama):</label>
                ...
                <div class="form-group">
                    <label for="note" class="form-control-label">email;:</label>
