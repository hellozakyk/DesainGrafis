          ...
          <div class="card-wrapper">
            <div class="card">
              <div class="card-header">
                <h3 class="mb-0">Data Pesanan Desain</h3>
                <?php if ($order_flash) : ?>
            ...
            <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="mb-0">Desain dalam pesanan</h3>
                    </div>
                    <div class="card-body p-0">
                ...
                <div class="card card-primary" id="#payments">
                    ...
                    <div class="card-body <?php echo ($data->payment_method == 1) ? 'p-0' : ''; ?>">
                      ...
                      <div class="alert alert-info">
                        Pesanan ini menggunakan metode pembayaran ditempat. Tidak memerlukan konfirmasi pembayaran.
                      </div>
                      <?php endif; ?>
                    </div>
                    <?php if ($data->payment_price != NULL) : ?>
