      ...
      <div class="modal-content">
        ...
        <form action="#" id="deleteProductForm" method="POST">
          ...
          <div class="modal-body">
            <p class="deleteText">Yakin ingin menghapus produk ini? Semua data yang terkait seperti data Pesanan juga akan dihapus. Tindakan ini tidak dapat dibatalkan.</p>
          </div>
