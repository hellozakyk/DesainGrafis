      ...
      <div class="row">
        <div class="col-md-8">
          <div class="card-wrapper">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="mb-0">Rekening Pembayaran</h3>
              ...
              <?php else : ?>
              <div class="alert alert-info alert-zero">Belum ada data bank yang ditambahkan. Tambahkan yang Rekening !</div>
              <div class="increment">
                <div class="row">
                  <div class="col-12">
                    <div class="form-group">
