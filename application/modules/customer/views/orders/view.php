    ...
    <section class="content">
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="card card-primary">
                    <div class="card-header">
                        <h5 class="card-heading">Proses Pesanan</h5>
                    </div>
                    <div class="card-body p-0">
            ...
            <div class="col-md-4">
                <div class="card card-primary">
                    <div class="card-header">
                        <h5 class="card-heading">Data Pelanggan</h5>
                    </div>
                    <div class="card-body p-0">
                        <table class="table table-hover table-striped table-hover">
                            <tr>
        ...
        success: function (res) {
            if (res.code == 200) {
                ...
                if (res.success) {
                    ...
                    $('.actionRow').html('Pesanan dibatalkan');
                }
                else if (res.error) {
    ...
    $.ajax({
        ...
        success: function (res) {
            if (res.code == 200) {
                ...
                if (res.success) {
                    del.html('Pesanan dan semua datanya berhasil dihapus');
