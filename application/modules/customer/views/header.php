    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?php echo site_url('home'); ?>" class="nav-link selection">
          ...
          <li class="nav-item">
          <a href="<?php echo site_url('customer'); ?>" class="nav-link selection" >
          ...
          <li class="nav-item">
            <a href="<?php echo site_url('customer/orders'); ?>" class="nav-link selection">
          ...
          <li class="nav-item">
            <a href="<?php echo site_url('customer/payments'); ?>" class="nav-link selection">
          ...
          <li class="nav-item">
            <a href="<?php echo site_url('customer/reviews'); ?>" class="nav-link selection">
